...
import { encodeMessage, decodeMessage, frameMessage, parseFrame, MAX_FRAME_SIZE, } from '../protocol/messages.js';
...
describe('messages (CBOR encoding)', () => {
    ...
    it('encodes and decodes Ack message roundtrip', () => {
        ...
        expect(decoded.messageId).toBe('test-id-123');
    });
    ...
    it('decodeMessage throws on invalid type', () => {
        const bad = encodeMessage({ ...sampleAck, type: 0xfe });
...
describe('framing', () => {
    ...
    it('frames and parses a message roundtrip', () => {
        ...
        expect(result.message.messageId).toBe('frame-test');
